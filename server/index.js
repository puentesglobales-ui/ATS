...
const checkUsage = async (userId, usageType = 'general') => {
  ...
  try {
    ...
    if (profile) {
      ...
      if (profile.role === 'admin' || ['visasytrabajos@gmail.com', 'tutrabajoeneuropa@gmail.com', 'puentesglobales@gmail.com'].includes(profile.email) || profile.is_premium) {
        return { allowed: true };
      }
...
app.post('/api/profile', async (req, res) => {
  ...
  try {
    ...
    if (['visasytrabajos@gmail.com', 'tutrabajoeneuropa@gmail.com', 'puentesglobales@gmail.com'].includes(email)) {
      role = 'admin';
      is_premium = true;
